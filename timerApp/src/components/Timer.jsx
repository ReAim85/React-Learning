...
const Timer = () => {
  ...
  <div className={style.timerApp}>
    ...
    <div className={style.actionButtons}>
      <button className={style.actionButtons} onClick={() => setIsRunning(!isRunning)}>
      {isRunning ? "Pause" : "Start"}
      </button>
      <button className={style.actionButtons} onClick={() => {setTime(0); setInitialTime(0); setIsRunning(false); }}>
        Reset
      </button>
